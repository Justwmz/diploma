              ...
              <ul class="list-group">
                  <li class="list-group-item">
                    <span class="badge">
                      ...
                      $all_query = count($incidents);
                      echo $all_query;
                      ?>
                    </span>
                    <b>Загальна кількість запитиів</b>
                  </li>
                  <li class="list-group-item">
                    <span class="badge">
                      <?php
                      $incidents = $db->getAll("SELECT * FROM incidents where status = 1");
                      $all_query = count($incidents);
                      echo $all_query;
                      ?>
                    </span>
                    <b>Кількість вирішиних запитив</b>
                  </li>
                  <li class="list-group-item">
                    <span class="badge">
                      <?php
                      $incidents = $db->getAll("SELECT * FROM incidents where status = 2");
                      $all_query = count($incidents);
                      echo $all_query;
                      ?>
                    </span>
                    <b>Кількість не вирішиних запитив</b>
                  </li>
                  <li class="list-group-item">
                    <span class="badge">
                      <?php
                      $incidents = $db->getAll("SELECT * FROM incidents where status = 3");
                      $all_query = count($incidents);
                      echo $all_query;
                      ?>
                    </span>
                    <b>Кількість запитив в обробці</b>
                  </li>
                </ul>          
            </div>        
          </div>
